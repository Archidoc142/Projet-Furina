...
$bddResults = $bdd->query("SELECT id, name, type, rarity, type_id FROM food;");
         ...
         <div class="filter-body">
            ...
            <div class="filter-element">
               ...
               <div class="flex filter-arme-con">
                  <img class="filter-button active" src="img/icon/HpAdd.png" alt="food_icon" data-val='1'>
                  <img class="filter-button active" src="img/icon/Revive.png" alt="food_icon" data-val='2'>
                  <img class="filter-button active" src="img/icon/HpAddAll.png" alt="food_icon" data-val='3'>
                  <img class="filter-button active" src="img/icon/SPReduceConsume.png" alt="food_icon" data-val='4'>
                  <img class="filter-button active" src="img/icon/CritRate.png" alt="food_icon" data-val='5'>
                  <img class="filter-button active" src="img/icon/Def_Add.png" alt="food_icon" data-val='6'>
                  <img class="filter-button active" src="img/icon/SPAdd.png" alt="food_icon" data-val='7'>
                  <img class="filter-button active" src="img/icon/Atk_Add.png" alt="food_icon" data-val='8'>
                  <img class="filter-button active" src="img/icon/Climate_Heat.png" alt="food_icon" data-val='9'>
               </div>
            </div>
            <div class="filter-element hidden">
               <div class="flex whitneyBold">
                  <h3></h3>
                  <div class="filter-button active button-all"><p></p></div>
               </div>
      ...
      <div class="flex objectList">
         <?php
            ...
            foreach ($bddResults as $row) {
               echo "<a href='p/food.php?id=" . $row['id'] . "' class='objectList-item' data-nom='" . $row['name'] . "' data-rarity='" . $row['rarity'] . "' data-arme='" . $row['type_id'] . "' style='order:" . $j . "'>";
               echo "<div class='objectList-container'>";
                     echo "<img src='img/nourriture/" . rawurlencode($row['name']) . ".png' alt='" . $row['name'] . "' class='objectList-avatar " . 'c' . $row['rarity'] . "'>";
                     echo "<img src='img/icon/" . $row['type'] . ".png' alt='" . $row['type'] . "' class='objectList-element'>";
