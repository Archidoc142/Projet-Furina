...
$bddResults = $bdd->query("SELECT name, type FROM monstre ORDER BY type, id;");
      ...
      <div class="flex box-object-tri">
         ...
         <div class="typeNPC">
            <select name="selectionType" id="selectionType" class="whitneyBold" onchange="selectObject()">
               ...
               <option value="4">Fatui</option>
               <option value="5">Automates</option>
               <option value="6">Humains</option>
               <option value="7">Bêtes mystiques</option>
