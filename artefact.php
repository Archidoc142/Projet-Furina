...
$bddResults = $bdd->query("SELECT * FROM artefact WHERE objectId = '1';");
...
<main>
   <div class="filter" id="filter">
      ...
      <div class="filterContent">
         <div class="filter-body">
            ...
            <div class="filter-element">
               <div class="flex whitneyBold hidden">
                  <h3>Type</h3>
                  <div class="filter-button active button-all"><p>All</p></div>
               </div>
   ...
   <div class="box-object">
      <h1 class="whitneyBold">Archive / Artéfacts</h1>
         ...
         <?php
            ...
            foreach ($bddResults as $row) {
               ...
               echo "<div class='objectList-container'>";
                     ...
                     echo "<div class='objectList-card whitneyBold'><div class='nameObject'><span class='nmSpan'>" . $row['setName'] . "</span></div>";
