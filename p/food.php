<?php
   ...
   $stmt = $bdd->prepare("SELECT * FROM food WHERE id = :id");
         ...
         <div class="containerPageInfo">
            <div class="flex mainInfo c<?php echo $bddResults['rarity']; ?>">
               ...
               <div class="divStatImg">
                  <img src="img/nourriture/<?php echo $bddResults['name']; ?>.png" alt="object_icon">
               </div>
            </div>
            <div class="descriptionObject">
               <p class="descObj effetFood"><?php echo $bddResults['effet']; ?></p>
