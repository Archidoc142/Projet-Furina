...
<main>
   ...
   <div class="persoInfo whitneyBold">
      ...
      <div class="profile contenu container poppinsLight">
         ...
         <div class="descPerso">La 77e directrice du Funérarium Wangsheng, qui redonne un coup de jeune à la gestion des affaires funéraires de Liyue.</div>   <!--Description-->
      </div>
         ...
         <div class="autreGrid">         
            <div>
               ...
               <div class="other namecardOther">
                  <div>
                     <img src="img/namecard/Hu Tao - Pacificatrice2.png" alt="namecard">  <!--Namecard-->
