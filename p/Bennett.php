<?php
   ...
   $stmt = $bdd->prepare("SELECT * FROM personnage WHERE name = 'Bennett';"); // Personnage
   $food = $bdd->query("SELECT id, name, type, rarity, type_id FROM food WHERE id = 50;"); // Nourriture
   $stmt->execute();
   $food->execute();
   ...
   <div class="persoInfo whitneyBold">
      <div class="categorie">
         <div class="persoPresentation container">
            ...
            <p class="titrePerso">Prince de la guigne</p> <!-- Titre -->
            <?php
               echo "<div class='flex'>";
      ...
      <div class="profile contenu container poppinsLight">
         ...
         <table class="tbH"> <!-- Table des propriétés-->
               ...
               <tr>
                  ...
                  <td>Rota Calamitas</td>   <!--Constellation-->
               </tr>
               <tr>
                  <td class="flex">Affiliation</td>
                  <td>Guilde des aventuriers</td>   <!--Description-->
               </tr>
               <tr>
                  <td class="flex">Anniversaire</td>
                  <td>2/29</td>   <!--Description-->
               </tr>
         </table>

         <div class="descPerso">Un jeune aventurier originaire de Mondstadt. Sa gentillesse n'a d'égale que sa guigne.</div>   <!--Description-->
      </div>
         ...
         <div class="autreGrid">         
            <div>
               ...
               <div class="other namecardOther">
                  <div>
                     <img src="img/namecard/Bennett - Gratitude2.png" alt="namecard">  <!--Namecard-->
                     <div class="nmTitle">Bennett - Gratitude</div>  <!--Titre-->
                     <div class="nmDesc">Un signe de reconnaissance de la part de la Bande à Benny.</div>  <!--Description-->
                  </div>
               </div>
            </div>
            <div>
            ...
            <div class="outfit">
               ...
               <div class="other otherOutfit"> <!--À garder s'il y a plusieurs tenue-->
                  ...
                  <div class="poppinsLight">
                     <div class="descTenue">
                     <p><strong>Diversion mal venue</strong></p> <!--Titre-->
                     <p>Tenue de Bennett. Un vieux costume d'aventurier tout rapiécé.</p> <!--Description-->
